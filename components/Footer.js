      ...
      <div className="py-10 font-Poppins container mx-auto px-10">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <h1 className="lg:w-2/5 font-Poppins font-normal text-black/75 p-7">
          ...
          <div className="grid grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-2">
            <div>
              ...
              <ul className="text-black/50 font-semibold">
                <li className="mb-4">
                  <Link
        ...
        <hr className="my-6 border-black/70 sm:mx-auto" />
        <div className="sm:flex sm:items-center sm:justify-between px-16">
          <span className="text-sm text-black/60 font-normal sm:text-center">
            &copy; 2023
            <Link
